...
//   // if (localStorage.getItem('prodcts') === null) {
//     // const arrayString = JSON.stringify(prodcts.all);
//     // localStorage.setItem('prodcts', JSON.stringify(prodcts.all));
//   // }
//   // console.log(prodcts.all);
// // }
...
//   // let localStorageProducts = getprodcts();

//   // for (let i=0 ;i<localStorageProducts.length;i++){
//   //   localStorageProducts[i].views =localStorageProducts[i].views + prodcts.all[i].views;
//   // }
//   // localStorage.setItem('prodcts', JSON.stringify(localStorageProducts));
// }
